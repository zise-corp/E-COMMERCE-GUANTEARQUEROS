...
export function FloatingWhatsapp() {
  return (
    <a
      ...
      className="group fixed bottom-4 right-4 z-[35] flex size-[52px] items-stretch bg-[linear-gradient(145deg,#ff7a3d,#eb611c_55%,#943b10)] p-px shadow-[0_14px_34px_rgba(0,0,0,0.55),0_0_20px_rgba(235,97,28,0.12)] transition-[transform,filter,box-shadow] duration-200 [clip-path:polygon(0_13px,13px_0,100%_0,100%_100%,0_100%)] hover:-translate-y-1 hover:brightness-110 hover:shadow-[0_18px_38px_rgba(0,0,0,0.58),0_0_24px_rgba(235,97,28,0.22)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-ink-950 sm:bottom-7 sm:right-7 sm:size-14"
    >
